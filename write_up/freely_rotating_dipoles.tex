...
Equilibria and equations of motion in hand we can do small angle perturbations. Noting that near an equilibrium point $\Gamma_i$ the changes in momenta are tiny we can do a multi-variable taylor expansion and produce the expression.

\begin{equation}\label{taylor_force}
	\dot p_n \approx \Sigma_m \partial_{q_m}(-\partial_{q_n} H)|_{\Gamma_i} q_m 
\end{equation}
...
To get this amenable to periodic solutions, we would like to recast the momentum vector in terms of a time derivative of our position.
