...
%r2i rephrasing high energy behavior of spinning mode	
...
%r2ii the first paragraph problem, how dense do we make it and avoid burrying the lede? proposes taking 4th paragraph and making part or most of it in the 1st paragraph. 09/10 After consideration, reviewer 2's 2nd recommendation is not obviously enough an improvement considering audience and expositional pacing needs.
...
%r2iii explain what is not chaotic about it. V
...
%r2iv extra sentence, maybe include citation to common explanation
% butkov 1st ed tensors 16.6 pg 690
% just use taylor :/ 09/10 not sure how much more detail can be done.
...
\end{equation}
%r2v: punctuation, treating equations as nouns
...
The spinning and orbital modes were examined independently as they are not coupled together when the contact criterion is maintained. Two hundred initial conditions were simulated with closer resolution taken near transition points. In the case of the spinning mode, the maximum initial kinetic energy was 1/2, taking it well past the point where it begins spinning freely. We see that it's period as a function of energy reproduces the curve described in a detailed analysis of the basic pendulum \cite{doi:10.1119/1.3442472}. In the case of the orbital mode, the maximum energy was just below the point where the contact criterion was broken, 1/3 units of initial kinetic energy.
% r2vi: flesh out the analysis and reference previous work on critical transition for spinning mode
\begin{figure}[h]
	\centering
