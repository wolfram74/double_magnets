...
%emphasise the value of going through the hamiltonian in a system that's comprehensible /and/ has some unexpected results
...
\begin{equation}\label{tht_int}
  ...
  \end{multlined}
\end{equation}
%04/16 sweep through and set up any references with proper equation prefix
