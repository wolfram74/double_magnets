...
Examining the interactions between rotating magnets has interesting applications when we consider how toothless gears \cite{doi:10.1119/1.5029823} and magnets are being used in engineering contexts.
...
Pollack \cite{doi:10.1139/p96-151} has looked at simplified point dipoles fixed in space but free to rotate and how they interact, finding quasi periodic motion.
Edwards et al has taken advantage of some work that shows magnetized spheres produce magnetic fields identical to point dipoles \cite{Edwards:2017aa} to look at how one sphere can freely slide around on the surface of another sphere fixed in space and discovering it leads to chaotic movement \cite{Edwards:2017ab}.
...
Numerical work has been done on more complicated arrangements \cite{Furlani:1995aa} and by examining this simple case analytically we can provide an additional check on their results.
As this is a system where the magnetic interaction, it can make accounting for all the forces a point of contention\cite{Boyer:1988aa} \cite{Vaidman:1990aa} \cite{Griffiths:1992aa} \cite{Brownstein:1993aa}  \cite{Hnizdo:1997aa}.
There is little disagreement on the energy for a dipole in a magnetic field \cite{Greene:1971aa} \cite{Griffiths:1992aa}, however.
...
%some magnetic interactions are complicated \cite{Boyer:1988aa} \cite{Brownstein:1993aa}
%Potential energy of dipole \cite{Greene:1971aa} √
%Torques lead to confusion \cite{Vaidman:1990aa}√
%Torques and potential energy 	\cite{Griffiths:1992aa}
%A great deal of effort can go into maintaining validity in the newtonian framework \cite{Hnizdo:1997aa}
...
%05/07 make a bit more direct, try to get to the motiviation/rationale faster, consider rearranging in depth description of the system vs techniques used to treat it
%05/07 hamiltonian, iffy, the fact that it's physically easily imagined
%05/07 why do people care: instance of more complicated phase space leads to less complicated dynamics
%05/07 why do people care: instance of more complicated phase space leads to less complicated dynamics
